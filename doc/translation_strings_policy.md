...
This document provides guidelines for internationalization of the shahepay Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shahepay_en.ts` remains unchanged.
