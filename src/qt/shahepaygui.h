...
#ifndef SHAHEPAY_QT_SHAHEPAYGUI_H
#define SHAHEPAY_QT_SHAHEPAYGUI_H
...
/**
  shahepay GUI main class. This class represents the main window of the shahepay UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class shahepayGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit shahepayGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~shahepayGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a shahepay wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // SHAHEPAY_QT_SHAHEPAYGUI_H
