 ...
 */
#ifndef SHAHEPAY_UTIL_H
#define SHAHEPAY_UTIL_H
...
extern const char *const SHAHEPAY_CONF_FILENAME;
extern const char *const SHAHEPAY_PID_FILENAME;
...
{
    std::string s = strprintf("shahepay-%s", name);
