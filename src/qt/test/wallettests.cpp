...
#include "qt/shahepayamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<shahepayAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_shahepay-qt -platform xcb      # Linux
//     src/qt/test/test_shahepay-qt -platform windows  # Windows
//     src/qt/test/test_shahepay-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = shahepayUnits::formatWithUnit(unit, balance, false, shahepayUnits::separatorAlways);
    ...
    // Amount input
    shahepayAmountField* amountInput = receiveCoinsDialog.findChild<shahepayAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: shahepay:")) != -1);
