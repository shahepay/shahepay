...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/shahepay/shahepay/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/shahepay/shahepay/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/shahepay/shahepay/pull/7415) for an example.
...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://shahepay.site/cfields/osslsigncode-Backports-to-1.7.1.patch
...
space *do not upload these to the shahepay.site server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the shahepay.site server
...
people without access to `shahepay.site` to download the binary distribution.
Also put it into the `optional_magnetlink:` slot in the YAML file for
shahepay.site (see below for shahepay.site update instructions).
...
- Announce the release:
  ...
  - shahepay Core announcements list https://shahepay.site/en/list/announcements/join/
  ...
  - Create a [new GitHub release](https://github.com/shahepay/shahepay/releases/new) with a link to the archived release notes.
