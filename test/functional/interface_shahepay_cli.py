...
class TestshahepayCli(shahepayTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `shahepay-cli getinfo`")
        ...
        self.log.info("Compare responses from `shahepay-cli -getinfo` and the RPCs data is retrieved from.")
