...
#ifndef SHAHEPAY_CONSENSUS_CONSENSUS_H
#define SHAHEPAY_CONSENSUS_CONSENSUS_H
...
static const int COINBASE_MATURITY = 25; // change maturity from 100 to 26
...
#endif // SHAHEPAY_CONSENSUS_CONSENSUS_H
