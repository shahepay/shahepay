...
class WalletTest(shahepayTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SHAHE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SHAHE with subtract fee from amount
        ...
        # Sendmany 10 SHAHE with subtract fee from amount
