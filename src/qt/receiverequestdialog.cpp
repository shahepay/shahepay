...
#include "config/shahepay-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatshahepayURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + shahepayUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatshahepayURI(info));
}
