...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2100000; //210000;  //~ 4 yrs at 1 min block time
        ...
        checkpointData = (CCheckpointData) {
            {
                ...
                { 812862, uint256S("0x000000002d8322e4b34ade678aafd1945effdcccfd9b4971d401463268d464bd")}
	    }
        };
