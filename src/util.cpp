...
const char * const BITCOIN_CONF_FILENAME = "shahepay.conf";
const char * const BITCOIN_PID_FILENAME = "shahepay.pid";
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", SHAHEPAY_PID_FILENAME));
