...
#ifndef SHAHEPAY_QT_SHAHEPAYUNITS_H
#define SHAHEPAY_QT_SHAHEPAYUNITS_H
...
/** shahepay unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class shahepayUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit shahepayUnits(QObject *parent);

    /** shahepay units.
      @note Source: https://en.shahepay.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SHAHE,
...
typedef shahepayUnits::Unit shahepayUnit;

#endif // SHAHEPAY_QT_SHAHEPAYUNITS_H
